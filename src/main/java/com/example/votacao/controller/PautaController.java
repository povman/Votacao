...
public class PautaController {
    ...
    public ResponseEntity<List<Map<String, Object>>> listarPautas() {
        try {
            List<PautaEO> pautas = pautaRepository.findAll();
            List<Map<String, Object>> responseList = new ArrayList<>();

            for (PautaEO pauta : pautas) {
    ...
    public ResponseEntity<Map<String, Object>> criarPauta(@RequestBody Map<String, String> requestBody) {
        try {
            ...
            if (descricao != null && !descricao.isEmpty()) {
                PautaEO novaPauta = new PautaEO(descricao);
    ...
    public ResponseEntity<Map<String, Object>> atualizarPauta(@PathVariable Long id, @RequestBody PautaEO pautaRequest) {
        PautaEO pautaAtualizada = new PautaEO(pautaRequest.getDescricao());
